"""
https://leetcode.com/problems/rotate-image/description/?envType=company&envId=roblox&favoriteSlug=roblox-all
...
class Solution:
    ...
    def _reflect_along_y(self, matrix: List[List[int]]):
        n = len(matrix)
