"""
https://leetcode.com/problems/design-hit-counter/description/?envType=company&envId=roblox&favoriteSlug=roblox-all
...
class HitCounter:
    ...
    def get_hits(self, timestamp: int) -> int:
        ...
        while self.window and self.window[0] <= self.curr_time - 300:
            self.window.popleft()
